...
/**
 * See https://picocli.info/#_default_provider
 *
 ...
 * </pre>
 *
 * Original code in https://github.com/remkop/picocli/blob/master/picocli-examples/src/main/java/picocli/examples/defaultprovider/PropertiesDefaultProvider.java
 * 
 * @author jhay
 */
public class SynBioHubCmdDefaultProvider implements IDefaultValueProvider {
     ...
     */
    public SynBioHubCmdDefaultProvider() {}
     ...
     * @see PropertiesDefaultProvider the PropertiesDefaultProvider class description
     */
    public SynBioHubCmdDefaultProvider(Properties properties) {
     ...
     * @see PropertiesDefaultProvider the PropertiesDefaultProvider class description
     */
    public SynBioHubCmdDefaultProvider(File file) {
